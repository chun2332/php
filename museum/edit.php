                        ...
                        <form name="myForm" method="POST" action="./updateEdit.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input class="form-control form-control-lg"  type="text" name="musName" value="<?php echo $arr[0]['musName']; ?>" maxlength="10">
                                </div>
                                <div class="col-lg-6 form-group">
                                    <label class="text-small text-uppercase">美術館編號</label>
                                    <input class="form-control form-control-lg" type="text" name="musId" value="<?php echo $arr[0]['musId']; ?>" maxlength="20">
                                </div>
